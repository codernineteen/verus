...
//
void VerusApp::setup(const VkInstance& instance, const VkDevice& device, const VkPhysicalDevice& physicalDevice, uint32_t queueFamily)
{
...
//
void VerusApp::updateUniformBuffer(const VkCommandBuffer& cmdBuf)
{
...
//
void VerusApp::createDescriptorSetLayout()
{
...
//
void VerusApp::updateDescriptorSet()
{
...
//
void VerusApp::createGraphicsPipeline()
{
...
//
void VerusApp::loadModel(const std::string& filename, glm::mat4 transform)
{
    LOGI("Loading File:  %s \n", filename.c_str());
    ObjLoader loader;
...
//
void VerusApp::createUniformBuffer()
{
...
// - Offset for texture
//
void VerusApp::createObjDescriptionBuffer()
{
...
//
void VerusApp::createTextureImages(const VkCommandBuffer& cmdBuf, const std::vector<std::string>& textures)
{
...
//
void VerusApp::destroyResources()
{
...
//
void VerusApp::rasterize(const VkCommandBuffer& cmdBuf)
{
    ...
    for (const VerusApp::ObjInstance& inst : m_instances)
    {
...
//
void VerusApp::onResize(int /*w*/, int /*h*/)
{
...
//
void VerusApp::createOffscreenRender()
{
    m_alloc.destroy(m_offscreenColor);
    m_alloc.destroy(m_offscreenDepth);
...
//
void VerusApp::createPostPipeline()
{
...
// fragment program.
//
void VerusApp::createPostDescriptor()
{
...
// Update the output
//
void VerusApp::updatePostDescriptorSet()
{
...
//
void VerusApp::drawPost(VkCommandBuffer cmdBuf)
{
